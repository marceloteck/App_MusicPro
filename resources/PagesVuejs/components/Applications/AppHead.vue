...
const NameApp = ((import.meta.env.VITE_APP_NAME || 'Tocare_Music').replace(/[_-]/g, ' '));
const defaultTitle = 'Tocare Music';
const defaultDescription = 'Letras de musicas, cifras e play nos videos';
const defaultKeywords = 'Tocare, musicas, cifras, letras, videos';
const defaultAuthor = 'Nanosistecck';
const defaultImageUrl = '';
const defaultUrl = window.location.href;
const typeWebSite = 'app'; // website
const twitterCard = ''; // summary_large_image

// config
const ColorScheme = "#fda543";
const themeColor = "#fda543";
const iconRel = "/Assets/image/logo/favicon.png";
